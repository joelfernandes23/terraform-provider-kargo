		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.0.image.0.repo_url", "ghcr.io/example/app"),
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.0.image.0.semver_constraint", "^1.0.0"),
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.0.image.0.tag_selection_strategy", "SemVer"),
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.0.image.0.platform", "linux/amd64"),
				),
			},
			{
				Config: testWarehouseResourceImageConfig(srv.URL, "tf-test-project", "tf-test-warehouse", "^2.0.0"),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.0.image.0.semver_constraint", "^2.0.0"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.0.git.0.repo_url", "https://github.com/example/repo.git"),
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.0.git.0.branch", "main"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.0.image.0.repo_url", "ghcr.io/example/app"),
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.1.git.0.repo_url", "https://github.com/example/repo.git"),
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.1.git.0.branch", "main"),
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.2.chart.0.repo_url", "https://charts.example.com"),
					resource.TestCheckResourceAttr("kargo_warehouse.test", "subscription.2.chart.0.name", "app"),
				),
			},
		},
	})
